<h1 align="center">Hi Devs, I'm Geohandry Nuñez <img src="https://media.giphy.com/media/hvRJCLFzcasrR4ia7z/giphy.gif" width="35"></h1>
...
-  🎓 I am a Senior Computer Technician from CUAM, Venezuela, currently pursuing computer engineering at Universidad Jose Antonio Paez, and I have a proven track record in delivering high-impact solutions. for companies like Papeles Venezolanos C.A. with GrandBay and Transporte los Angeles Partners of Empresas Polar.

## 🏆 &nbsp;Key Achievements
### 🚗 **At DFSK Venezuela**
- 🌐 Finished complementing and developing **RESTful API** using .NET 8 for database query, **Increasing the communication time between the company where it was developed by more than 60%**.
- 📱 ****An Application for browsers was created based on JS to manage different PowerBi graphics to improve efficiency and communication in the Distribution and dispatch area****.
- 📱 I developed an Artificial Intelligence for CUAM University which helps communicate with students and help them with their performance or knowledge in the required subject.
- 🛠️ **Maintained and updated legacy software** built with .NET Framework, Python, javascript, SQLite and SQL Server.
### 🏭 **At Papeles Venezolanos C.A. & GrandBay**
- 🌐 A **web platform and Called Fortnightly Meeting** was developed using .NET 6/8, C# and SQL Server, used daily by **Different Companies that make up GrandBay today** for the solution of Discrepancy.
- 🤖 I implemented **A program in Python** to control different televisions that are in the company and it shows different production information **It was implemented in a Rasberry PI in which it is used as a server today**.
- 🛠️ **Performing database migration** The database tables were optimized, improving operational efficiency and integrating reporting data from the **DBNEOII** and **CONTINUOUS IMPROVEMENT** servers.
- 📊 Create **metrics and Dynamic Tables** with Excel, providing information extracted from databases such as SQL server and Oracle that is actionable for decision making.
- 
## 💻 &nbsp;My Stack Work 
...
## 📞 &nbsp;Contact me
  <br>	
    <a target="_blank" href="https://www.linkedin.com/in/geohandry-nu%C3%B1ez-b4672821a/">
      <img src="https://img.shields.io/badge/-LinkedIn-0077B5?style=for-the-badge&logo=Linkedin&logoColor=white"></img></a>
        &emsp;
    <a target="_blank" href="mailto:geohaxd@gmail.com">
    <img src="https://img.shields.io/badge/-Gmail-D14836?style=for-the-badge&logo=Gmail&logoColor=white"></img></a>
        &emsp;
    <a target="_blank" href="https://wa.me/+584244477348">
